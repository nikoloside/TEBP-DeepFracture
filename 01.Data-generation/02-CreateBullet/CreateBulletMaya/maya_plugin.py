...
def makeGui():
	...
	cmds.textFieldButtonGrp('fromDir', label='From Directory Path', cw3 = [80,190,50], text='/Users/path/to/TEBP/data/norm/abstract_animal', buttonLabel='browse', buttonCommand=browseFrom, parent = 'uiColWrapper')
	cmds.textFieldButtonGrp('toDir', label='To Directory Path', cw3 = [80,190,50], text='/Users/path/to/TEBP/data/bullet/abstract_animal', buttonLabel='browse', buttonCommand=browseTo, parent = 'uiColWrapper')
